...
export class LibertaCoin extends SmartContract {
  public readonly properties = {
    codeVersion: '1.0',
    author: 'akcware',
    email: 'TODO',
    description: 'Liberta ICO',
  };
  public readonly name = 'Liberta Coin';
  public readonly symbol = 'LIB';
  ...
  private mutableRemaining: Fixed<8> = 100_000_000_00000000;
